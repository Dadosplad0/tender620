...
const COLOR_ACCENT = 0xFFff8e94;
const COLOR_PRIMARY_DARK = 0xFFc61f3c;
const COLOR_PRIMARY = 0xFFff5a66;
...
const LISTINGS = 'universal_listings';
const REVIEWS = 'universal_reviews';
const FILTERS = 'universal_filters';
const SAVED_LISTINGS = 'universal_saved_listings';
